            ...
            var settings = $.extend({}, this.opts, options),
                ...
                _render = function(items) {
                    ...
                    items = $(items).map(function(i, item) {
                        ...
                        if (item.image) {
                            _linkHtml.append('<img class="hashtag_image" src="' + item.image + '">');
                        }
                        if (item.name) {
                            _linkHtml.append('<b class="hashtag_name">' + item.name + '</b>');
                        }
                        if (item.username) {
                            _linkHtml.append('<span class="hashtag_username"> ' + settings.delimiter + item.username + '</span>');
                        }
